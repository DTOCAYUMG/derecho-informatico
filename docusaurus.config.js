...
const config = {
  ...
  tagline: 'Curso de Ingeniería en sistemas – Tercer Semestre',
  favicon: 'img/umg.ico',
  ...
  url: 'https://DTOCAYUMG.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/derecho-informatico/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'DTOCAYUMG', // Usually your GitHub org/user name.
  projectName: 'derecho-informatico', // Usually your repo name.
